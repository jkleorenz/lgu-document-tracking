...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'LGU Document Tracking System'); ?></title>
...
<body>
    ...
    <nav class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->routeIs('scan.*') ? 'active' : ''); ?>" href="<?php echo e(route('scan.index')); ?>">
                    <i class="bi bi-qr-code-scan"></i> Scan QR Code
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link position-relative <?php echo e(request()->routeIs('notifications.*') ? 'active' : ''); ?>" href="<?php echo e(route('notifications.index')); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->routeIs('archive.*') ? 'active' : ''); ?>" href="<?php echo e(route('archive.index')); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link position-relative <?php echo e(request()->routeIs('users.pending') ? 'active' : ''); ?>" href="<?php echo e(route('users.pending')); ?>">
                    <i class="bi bi-person-check"></i> Pending Verifications
                    <?php if(App\Models\User::where('status', 'pending')->count() > 0): ?>
                    <span class="badge bg-warning text-dark ms-auto"><?php echo e(App\Models\User::where('status', 'pending')->count()); ?></span>
                    <?php endif; ?>
                </a>
            </li>
            <?php endif; ?>
        ...
        <nav class="top-navbar">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center gap-3">
                    <span class="text-muted"><i class="bi bi-calendar3"></i> <?php echo e(date('F d, Y')); ?></span>
                </div>
                <div class="dropdown">
                    <a class="user-dropdown dropdown-toggle text-decoration-none" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div>
                            <div style="font-weight: 600; font-size: 0.9rem;"><?php echo e(auth()->user()->name); ?></div>
...
<?php /**PATH C:\xampp\htdocs\dashboard\lgu-document-tracking\resources\views/layouts/app.blade.php ENDPATH**/ ?>