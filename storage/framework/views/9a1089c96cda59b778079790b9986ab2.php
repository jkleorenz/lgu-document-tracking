    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <h4><?php echo e($document->title); ?></h4>
                    ...
                    <table class="table table-borderless mt-3">
                        ...
                        <tr>
                            <th>Description:</th>
                            <td><?php echo e($document->description ?? 'No description'); ?></td>
                        </tr>
                    </table>
                    ...
                    <div class="d-flex gap-2 mt-3">
                        ...
                        <a href="<?php echo e(route('scan.index')); ?>" class="btn btn-secondary">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <?php $__empty_1 = true; $__currentLoopData = $document->statusLogs->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="mb-3 pb-3 border-bottom">
                        <div class="mb-1">
                            <span class="badge bg-<?php echo e($log->new_status == 'Approved' ? 'success' : ($log->new_status == 'Received' ? 'success' : ($log->new_status == 'Pending' ? 'warning' : ($log->new_status == 'Rejected' ? 'danger' : 'info')))); ?>">
                                <?php echo e($log->new_status); ?>

                            </span>
                        </div>
                        <small class="text-muted">
                            <?php echo e($log->action_date->diffForHumans()); ?><br>
                            by <?php echo e($log->updatedBy->name); ?>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body text-center p-5">
                    ...
                    <form method="POST" action="<?php echo e(route('scan.process')); ?>" id="scanForm" class="mt-4">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            <input type="text" 
...
document.getElementById('scanForm')?.addEventListener('submit', function(e) {
    ...
    fetch('<?php echo e(route("scan.process")); ?>', {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dashboard\lgu-document-tracking\resources\views/scan/index.blade.php ENDPATH**/ ?>